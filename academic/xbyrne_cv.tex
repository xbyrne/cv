...
\begin{itemize}[leftmargin=8pt]
    ...
    }{MNRAS, 550(2)}{10.1093/mnras/stag1207}
    ...
    \paper{A.~Mata-Sanchez, E.~P.~Farina, A.~J.~Gloudemans, et al.\ inc.\ \textbf{X.~Byrne}}{2026, accepted}{
      To be lensed or not to be lensed: on the nature of the alleged high-$z$ lensed quasars J0109$-$5424 and P170$+$20.
    }{ApJ}{10.48550/arXiv.2608.25044}
\end{itemize}
...
\begin{itemize}
    ...
    \cvevent{Organiser, Exoplanet Seminar Series}{Oct 2026---}{
      Inviting speakers and coordinating talks for an interdepartmental seminar series on exoplanet science.
    }

    \cvevent{Organiser, Wednesday Seminar Series}{2024--26}{
      Coordinating and hosting this long-running seminar series, given by PhD students and postdocs at the Institute of Astronomy.
    }
...
\begin{itemize}
    ...
    \cvevent{LOC, Debris Disk Connections Workshop}{Jul 2026}{
      Assisting speakers and chairs at a large conference with presentations, mics etc.
    }
    ...
    \cvevent{LOC, \textit{IoA50} conference}{Jul 2024}{
      Assisting speakers and chairs at a large conference with presentations, mics etc.
    }
\end{itemize}
...
\begin{itemize}
    ...
    % \cvevent{Cambridge University Astronomical Society}{Oct 2026}{
    %   Talk on the Barnard's Star planetary system. This society has previously hosted talks by Hoyle, Eddington, Bell Burnell, and Queloz.
    % }

    \cvevent{Pint of Science}{May 2026}{
      A public talk in The Alexandra Arms pub, Cambridge: \textit{The 10 nearest stars to the Sun}
    }
...
\begin{itemize}
  \item \textbf{University of Cambridge}:
    \href{https://www.cam.ac.uk/research/news/astronomers-find-nearby-planets-to-be-small-strange-and-utterly-uninhabitable}{
