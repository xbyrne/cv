...
\begin{itemize}
    \item \textbf{X.~Byrne}, A.~Bonsor, L.~K.~Rogers et al. (2025).
    \textit{Finding rare classes in large datasets: the case of polluted white dwarfs from \textit{Gaia} XP spectra}. RASTI%, in press.
    %\href{https://doi.org/XX.XXXX/rasit/YYYYZZZZ}{doi:XX.XXXX/rasti/YYYYZZZZ}
