...
\begin{itemize}
    ...
    Awarded in recognitio-n of exceptional performance in the Natural Sciences examinations.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Astronomy Software:} EsoRex, EsoReflex, DS9, TOPCAT, IRAF, PyTorch, TensorFlow
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Produced popular revision notes ($\sim2500$ website hits per year)
\end{itemize}
